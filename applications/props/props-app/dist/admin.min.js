...
})}(window),!function(a){"use strict";function b(){a(".dropdown-backdrop").remove(),a(d).each(function(){c(a(this)).removeClass("open")})}function c(b){var c,d=b.attr("data-target");return d||(d=b.attr("href"),d=d&&/#/.test(d)&&d.replace(/.*(?=#[^\s]*$)/,"")),c=d&&a(d),c&&c.length||(c=b.parent()),c}var d="[data-toggle=dropdown]",e=function(b){var c=a(b).on("click.dropdown.data-api",this.toggle);a("html").on("click.dropdown.data-api",function(){c.parent().removeClass("open")})};e.prototype={constructor:e,toggle:function(){var d,e,f=a(this);if(!f.is(".disabled, :disabled"))return d=c(f),e=d.hasClass("open"),b(),e||("ontouchstart"in document.documentElement&&a('<div class="dropdown-backdrop"/>').insertBefore(a(this)).on("click",b),d.toggleClass("open")),f.focus(),!1},keydown:function(b){var e,f,g,h,i;if(/(38|40|27)/.test(b.keyCode)&&(e=a(this),b.preventDefault(),b.stopPropagation(),!e.is(".disabled, :disabled"))){if(g=c(e),h=g.hasClass("open"),!h||h&&27==b.keyCode)return 27==b.which&&g.find(d).focus(),e.click();f=a("[role=menu] li:not(.divider):visible a",g),f.length&&(i=f.index(f.filter(":focus")),38==b.keyCode&&i>0&&i--,40==b.keyCode&&i<f.length-1&&i++,~i||(i=0),f.eq(i).focus())}}};var f=a.fn.dropdown;a.fn.dropdown=function(b){return this.each(function(){var c=a(this),d=c.data("dropdown");d||c.data("dropdown",d=new e(this)),"string"==typeof b&&d[b].call(c)})},a.fn.dropdown.Constructor=e,a.fn.dropdown.noConflict=function(){return a.fn.dropdown=f,this},a(document).on("click.dropdown.data-api",b).on("click.dropdown.data-api",".dropdown form",function(a){a.stopPropagation()}).on("click.dropdown.data-api",d,e.prototype.toggle).on("keydown.dropdown.data-api",d+", [role=menu]",e.prototype.keydown)}(window.jQuery),window.BACKEND_HOST="[YOUR_BACKEND_HERE]";var makeRequest=function(a,b,c,d){if("post"==a){var e=c,f={href:b,format:"json",noCache:!0,headers:{"Content-Type":["application/json"]},body:e,authz:"signed"};console.log("post request: "+JSON.stringify(f)),osapi.http.post(f).execute(function(a){console.log("response: "+JSON.stringify(a)),d(a)})}else{var g;g=c?osapi.http.get({href:b,format:"json",noCache:!0,headers:{"Content-Type":["application/json"]},authz:"signed",body:JSON.stringify(c)}):osapi.http.get({href:b,headers:{Accept:["application/json"]},noCache:!0,authz:"signed"}),g.execute(function(a){console.log(a),d(a)})}},BASE_URL=window.BACKEND_HOST,defaultproptypes=[{$ItemName:"Genius",title:"Genius",definition:"You're a genius!",image_url:BASE_URL+"/img/prop_types/einstein.png",level:0},{$ItemName:"ThankYou",title:"Thank You",definition:"Thanks for all that you do!",image_url:BASE_URL+"/img/prop_types/flowers.png",level:0},{$ItemName:"Beer",title:"Beer",definition:"I owe you a beer!",image_url:BASE_URL+"/img/prop_types/beer.png",level:25},{$ItemName:"CrushedIt",title:"Crushed It",definition:"You squashed that bug dead!",image_url:BASE_URL+"/img/prop_types/bug-crusher.png",level:25},{$ItemName:"NightOwl",title:"Night Owl",definition:"You worked super late! Thanks!",image_url:BASE_URL+"/img/prop_types/owl.png",level:25},{$ItemName:"TurnedItTo11",title:"Turned It To 11",definition:"You did something amazing!",image_url:BASE_URL+"/img/prop_types/amplifier.png",level:100},{$ItemName:"KickAss",title:"Kick Ass",definition:"You kick ass!",image_url:BASE_URL+"/img/prop_types/chuck-norris.png",level:500},{$ItemName:"HoneyBadger",title:"Honey Badger",definition:"You're even more bad-ass than a honey-badger!",image_url:BASE_URL+"/img/prop_types/honey-badger.png",level:1e3}],noPropsHtml="<tbody><tr><td>No Props Here</td></tr></tbody>";gadgets.util.registerOnLoadHandler(function(){function a(){$("#title-inp").val(""),$("#definition-inp").val(""),$("#level-inp").val(""),$("#img-inp").val("")}$("#create-prop-type-tab").click(function(){$("#create-prop-type-tab").hide(),$("#remove-prop-type-tab").show(),a(),$("#remove-prop-types").fadeOut(400,function(){$("#create-prop-types").slideDown()})}),$("#remove-prop-type-tab").click(function(){$("#remove-prop-type-tab").hide(),$("#create-prop-type-tab").show(),$("#create-prop-types").fadeOut(400,function(){$("#remove-prop-types").slideDown()})}),$("#resetToDefaults").click(function(){console.log("Clicked reset to defaults"),confirm("Reset all prop types to default? This cannot be undone.")&&makeRequest("get",BASE_URL+"/props/types/reset",null,function(){loadPropTypesIntoRemoveTable(function(){alert("Prop Types have been reset.")})})}),$("#create-it").click(function(){function b(){makeRequest("post",BASE_URL+"/props/types",{title:c,definition:d,level:e,image_url:f,reflection_image_url:f},function(){loadPropTypesIntoRemoveTable(function(){a(),alertBox("success","The prop type "+c+" has been saved. Reload to see changes.")})})}var c=$("#title-inp").val(),d=$("#definition-inp").val(),e=$("#level-inp").val(),f=$("#img-inp").val();return c&&d&&f&&e?""==e||isNaN(e)||parseInt(e)<0||parseInt(e)>1e3?(alertBox("error","Level must be an integer from 0-1000"),a(),void 0):($("<img>",{src:f,error:function(){alertBox("error","Invalid Image URL."),a()},load:function(){b()}}),void 0):(alertBox("error","Please fill in all fields."),a(),void 0)}),loadPropTypesIntoRemoveTable(function(){$("#admin-panel-loading").hide(),$("#admin-panel-main").show(),$("#remove-prop-types").show()})});